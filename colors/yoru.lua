...
local black='#0c0e0f'
local altblack='#232526'
local red='#df5b61'
local altred='#e8646a'
local green='#78b892'
local altgreen='#81c19b'
local yellow='#de8f78'
local altyellow='#e79881'
local blue='#6791c9'
local altblue='#709ad2'
local magenta='#bc83e3'
local altmagenta='#c58cec'
local cyan='#67afc1'
local altcyan='#70b8ca'
local white='#edeff0'
local altwhite='#f2f4f5'
local grey='#485263'
...
local theme = {
  -- base
  Bold = { fg = blue, bold = true },
  Italic = { fg = altblue, italic = true },
  Underlined = { fg = cyan, special = magenta, underline = true },

  Normal = { fg = white, bg = black },
  Visual = { bg = altblack },
  VisualNOS = { bg = altblack },
  Search = { fg = altblack, bg = blue },
  IncSearch = { fg = altblack, bg = blue },
  CurSearch = { fg = altblack, bg = blue },
  MatchParen = { fg = altblack, bg = blue },
  ...
  CursorColumn = { bg = altblack },
  CursorLine = { bg = altblack },
  CursorLineNr = { fg = white, bg = altblack },
  ColorColumn = { bg = cyan },
  LineNr = { fg = grey },
